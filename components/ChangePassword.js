...
import { validatePassword } from '../helperFunctions/Validations/LoginValidation';
  ...
  const handleSubmit = async () => {
    try {
      if (
        ...
        await axios({
          method: 'post',
          url: `${BASE_URL_APP}/password/changePassword`,
          data: body,
        }).then(res => {
          setLoading(false);
              ...
              <View style={[styles.formGroup, styles.mt20]}>
                ...
                <View style={styles.formGroupIcon}>
                  <TextInput
                    ...
                    secureTextEntry={isPasswordSecure?.current}
                    placeholder="Current Password"
                  />
                  <TouchableOpacity
                    onPress={() => {
                      setIsPasswordSecure(prev => ({
                        ...prev,
                        current: !prev.current,
                      }));
                    }}>
                    <FontAwesome
                      name={isPasswordSecure?.current ? 'eye-slash' : 'eye'}
                      color={'#909090'}
                      size={20}
              ...
              <View style={styles.formGroup}>
                ...
                <View style={styles.formGroupIcon}>
                  <TextInput
                    ...
                    secureTextEntry={isPasswordSecure?.new}
                    value={newPassword}
                  ...
                  <TouchableOpacity
                    ...
                    <FontAwesome
                      name={isPasswordSecure?.new ? 'eye-slash' : 'eye'}
                      color={'#909090'}
                      size={20}
                      style={styles.showHideIcon}
                    />
              ...
              <View style={styles.formGroup}>
                ...
                <View style={styles.formGroupIcon}>
                  <TextInput
                    ...
                    secureTextEntry={isPasswordSecure?.confirm}
                  ...
                  <TouchableOpacity
                    ...
                    <FontAwesome
                      name={isPasswordSecure?.confirm ? 'eye-slash' : 'eye'}
                      color={'#909090'}
                      size={20}
                      style={styles.showHideIcon}
                    />
