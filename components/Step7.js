...
const Step7 = (props) => {
  ...
  const step8 = async () => {
    ...
    try {
      ...
      // const image1 = JSON.stringify(pooja1Image)
      // const image2 = JSON.stringify(pooja2Image)
      // const image3 = JSON.stringify(pooja3Image)


      pooja1 && await AsyncStorage.setItem("Pooja 1", pooja1Input) // JSON.parse(pooja1) when get data from localStorage
      pooja1Image.fileName && await AsyncStorage.setItem("Pooja 1 Image", image1);
      pooja2 && await AsyncStorage.setItem("Pooja 2", pooja2Input) // JSON.parse(pooja2) when get data from localStorage
      pooja2Image.fileName && await AsyncStorage.setItem("Pooja 2 Image", image2);
      pooja3 && await AsyncStorage.setItem("Pooja 3", pooja3Input) // JSON.parse(pooja3) when get data from localStorage
      pooja3Image.fileName && await AsyncStorage.setItem("Pooja 3 Image", image3);

      // alert('stored step 7')
      props.navigation.navigate("step8");
    } catch (error) {
      ...
      <View style={styles.mainHeaderOuter}>
        <LinearGradient
          ...
          <View style={styles.backMenuDiv}>
            <TouchableOpacity style={styles.backBtnDiv} onPress={() => props.navigation.navigate("step6")}>
              <Image source={require('../img/rightArrow1.jpg')} style={[styles.arrowBtn, styles.arrowBtnLight]} />
            </TouchableOpacity>
          </View>
          <Text style={[styles.headerTitle]}> Special Puja's </Text>
        </LinearGradient>
      </View>
                  ...
                  <View style={styles.formGroupNew}>
                    ...
                    <View style={styles.textAreaContainer}>
                      <TextInput
                        ...
                        value={pooja1.description}
                        onChangeText={value => setPooja1({ ...pooja1, description: value })}
                ...
                <View style={styles.formGroupDiv}>
                  <View style={styles.formGroupNew}>
                    ...
                    <View style={styles.textAreaContainer}>
                      <TextInput
                        style={styles.textArea}
                        value={pooja2.description}
                        onChangeText={value => setPooja2({ ...pooja2, description: value })}
                ...
                <View style={styles.formGroupDiv}>
                  <View style={styles.formGroupNew}>
                    ...
                    <View style={styles.textAreaContainer}>
                      <TextInput
                        style={styles.textArea}
                        value={pooja3.description}
                        onChangeText={value => setPooja3({ ...pooja3, description: value })}
