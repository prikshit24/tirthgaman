...
const Details = (props) => {
  ...
  const [propertyInfo, setPropertyInfo] = useState({
    title: '', headPoojari: '', trustName: '', description: ''
  })
  ...
  const step2 = async () => {
    ...
    const isTitle = validateTempleInputs(propertyInfo.title)
    // const isHeadPoojari = validateTempleInputs(propertyInfo.headPoojari)
    // const isTrustName = validateTempleInputs(propertyInfo.trustName)
    const isDescription = validateTempleInputs(propertyInfo.description)

    setErrors({ ...errors, title: isTitle, description: isDescription })

    if (isTitle && isDescription) {
      try {
        const templeInfo = JSON.stringify(propertyInfo)
        const social = JSON.stringify(socialLinks)
        await AsyncStorage.setItem('templeInfo', templeInfo)
    ...
    <View style={{ flex: 1, backgroundColor: '#ffffff' }}>
      ...
      <View style={styles.mainHeaderOuter}>
        <LinearGradient
          ...
          <Text style={[styles.headerTitle]}>Temple Info</Text>
        </LinearGradient>
      </View>
            ...
            <View style={[styles.centerBoxNo, styles.btnFixContainer]}>
              <View style={styles.formOuter}>
                <View style={[styles.MainTitleDiv]}>
                  <Text style={[styles.mainTitleText2, styles.textEarthyRed]}>Temple Info</Text>
                </View>

                <View style={[styles.formGroupDiv, styles.mt20]}>
                  <View style={styles.formGroupNew}>
                    <Text style={styles.formLabelNew}> Temple Title*</Text>
                    <TextInput
                      style={styles.formControlNew}
                      value={propertyInfo.title}
                      onChangeText={value => setPropertyInfo({ ...propertyInfo, title: value })}
                      placeholderTextColor="#888"
                    />
                    {!errors.title && (
                      <Text style={{ color: 'red', fontSize: 13 }}>
                        Enter Title for Temple
                      </Text>
                    )}
                  </View>
                </View>
                <View style={styles.formGroupDiv}>
                  <View style={styles.formGroupNew}>
                    <Text style={styles.formLabelNew}>Head Pujari</Text>
                    <TextInput
                      style={styles.formControlNew}
                      value={propertyInfo.headPoojari}
                      onChangeText={value => setPropertyInfo({ ...propertyInfo, headPoojari: value })}
                      placeholderTextColor="#888"
                    />
                  </View>
                </View>
                ...
                <View style={styles.formGroupDiv}>
                  <View style={styles.formGroupNew}>
                    <Text style={styles.formLabelNew}>Trust Name</Text>
                    <TextInput
                      style={styles.formControlNew}
                      value={propertyInfo.trustName}
                      onChangeText={value => setPropertyInfo({ ...propertyInfo, trustName: value })}
                      placeholderTextColor="#888"
                    />
                  </View>
                </View>
                  ...
                  <View style={styles.formGroupNew}>
                    ...
                    <View style={styles.textAreaContainer}>
                      <TextInput
                        ...
                        onChangeText={value => setPropertyInfo({ ...propertyInfo, description: value })}
                        placeholder=""
                    ...
                    {!errors.description && (
                      <Text style={{ color: 'red', fontSize: 13 }}>
                        Description of Temple is important
                      </Text>
                    )}
                  </View>
                </View>
      ...
      <View style={styles.fixBtnDiv}>
        <View style={styles.innerFlex}>
          <View style={styles.amtDiv}>
            <Text style={styles.amtTextLabel}>Step 1 of 8</Text>
          </View>
        </View>
        <View style={styles.innerFlex}>
