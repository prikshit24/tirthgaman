  ...
  const socialLinks = [
    {
      title: 'Facebook',
      icon: 'facebook',
      href: userData?.socials?.facecook,
    },
    {
      title: 'Twitter',
      icon: 'twitter',
                  ...
                  {userInfo?.map((item, index) => (
                    <View key={index} style={[styles.formGroupDiv]}>
                      <View style={styles.formGroupNew}>
                        ...
                        <Text style={styles.formLabelNew2}> {item?.value}</Text>
                      </View>
                    </View>
                  ))}
                </View>
              ...
              <View style={[styles.btnFixContainer]}>
                <View style={styles.formOuter}>
                  ...
                  <View style={styles.socialContainer}>
                    ...
                    {(userData?.socials && userData?.socials?.facecook !== '') &&
                      <TouchableOpacity
                        onPress={() => handleOpenLink(userData?.socials?.facecook)}>
                    ...
                    {(userData?.socials && userData?.socials?.twitter !== '') &&
                      <TouchableOpacity
                        onPress={() => handleOpenLink(userData?.socials?.twitter)}>
                        <View style={[styles.social]}>
                          <LinearGradient
                            start={{ x: 0, y: 0 }}
                            end={{ x: 1, y: 0 }}
                    ...
                    {(userData?.social && userData?.socials?.linkedin !== '') &&
                      <TouchableOpacity
                        onPress={() => handleOpenLink(userData?.socials?.linkedin)}>
                        <View style={[styles.social]}>
                          <LinearGradient
                            start={{ x: 0, y: 0 }}
                            end={{ x: 1, y: 0 }}
                    ...
                    {(userData?.socials && userData?.socials?.whatsapp !== '') &&
                      <TouchableOpacity
                        onPress={() => handleOpenLink(userData?.socials?.whatsapp)}>
                        <View style={[styles.social]}>
                          <LinearGradient
                            start={{ x: 0, y: 0 }}
                            end={{ x: 1, y: 0 }}
