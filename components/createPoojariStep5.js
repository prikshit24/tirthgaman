...
const createPoojariStep5 = (props) => {
  ...
  const step6 = async () => {
    try {
      await AsyncStorage.setItem("videoTitle", poojariImage.title)
      await AsyncStorage.setItem("videoLink", poojariImage.video)
      props.navigation.navigate("createPoojariStep6");
    } catch (err) {
    }
  }
      ...
      <View style={styles.mainHeaderOuter}>
        <LinearGradient
          ...
          <View style={styles.backMenuDiv}>
            <TouchableOpacity style={styles.backBtnDiv} onPress={() => props.navigation.navigate("createPoojariStep4")}>
                  ...
                  <View style={styles.formGroupNew}>
                    ...
                    <View style={[styles.row, styles.spaceBetween, styles.mt20]} >
                      {/* <View style={[styles.row, styles.spaceBetween]} > */}
                        <View style={{ maxWidth: '100%', margin: 0, padding: 0 }}>
                          <TextInput
                            style={styles.formControlNewthree}
                            value={poojariImage.title}
                            placeholder="Video Title"
                            onChangeText={value => setpoojariImage({ ...poojariImage, title: value })}

                            placeholderTextColor="#888"
                          />
                          <TextInput
                            style={styles.textArea}
                            value={poojariImage.video}
                            onChangeText={value => setpoojariImage({ ...poojariImage, video: value })}
...
export default createPoojariStep5;